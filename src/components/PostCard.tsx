      ...
      <div className="p-8">
        ...
        {post.repoUrl && (
          <div className="flex items-center mt-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 text-theme-muted" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a 
              ...
              className="text-xs text-theme-muted hover:text-theme-link transition-colors"
            >
              View Repository
            </a>
          </div>
