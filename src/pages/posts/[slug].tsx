    ...
    return (
        <>
            ...
            <article className="max-w-2xl mx-auto">
                ...
                <div
                    className="prose prose-lg max-w-none prose-headings:tracking-tight prose-headings:font-normal prose-p:text-theme-body prose-a:text-theme-link prose-a:font-normal prose-a:no-underline hover:prose-a:underline prose-strong:text-theme-heading prose-li:text-theme-body prose-p:text-justify before:prose-p:content-none after:prose-p:content-none"
